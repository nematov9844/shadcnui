export function Hero() {
  return (
    <div className="my-24">
      <h1 className="text-3xl font-bold leading-tight tracking-tighter md:text-5xl lg:leading-[1.1] text-left">
        <span className="relative">
          <svg style={{fill: 'hsl(var(--primary))'}} aria-hidden="true" viewBox="0 0 418 42" className="absolute left-0 top-2/3 h-[0.58em] w-full opacity-70" preserveAspectRatio="none">
      ...
      <span className="max-w-[750px] text-lg font-light text-foreground w-full text-left">
        Elegant, Simple, and Powerful NextJS boilerplate <br />with all you need to build your SaaS.
      </span>
      <div className="mt-4 flex items-center">
        <a target="__blank" href="https://forms.gle/guGfPLDGrsWoF8uw9">
