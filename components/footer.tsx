// Importlarni olib tashlaymiz
// import Link from "next/link"
// import { LogoIcon } from "./icons/logo"

export function Footer() {
  return (
    <footer className="mx-auto max-w-[1440px] pt-36 px-4">
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 mb-16">
        <div className="w-full md:max-w-[550px]">
          <h2 className="text-2xl font-bold leading-tight tracking-tighter md:text-4xl lg:leading-[1.1] text-left">
          ...
          <p className="font-medium text-secondary-foreground mt-6">
            <a className="underline" href="https://pro.shadcn.net" target="__blank">
              Shadcn UI Pro
            </a>{" "}
            is Powerful NextJS boilerplate build with{" "}
            <a className="underline" href="https://ui.shadcn.com/" target="__blank">
              shadcn/ui
            </a>
            .
          </p>
        ...
        <div className="w-full md:max-w-[650px] flex flex-col md:flex-row justify-between gap-10">
          <div>
            ...
            <ul className="flex flex-col gap-3 text-secondary-foreground">
